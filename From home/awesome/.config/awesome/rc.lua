...
local bar_themes = {
    ...
    "totoro",       -- 6 -- Inspired by totoro's polybar in github's dotfiles
}
...
user = {
    ...
    openweathermap_key = "de3fb7cb646f92f4a97b4b05f81c0a6b",
    openweathermap_city_id = "3459712",
...
awful.rules.rules = {
    ...
    -- File managers
    {
        ...
        properties = { floating = true, width = screen_width * 0.75, height = screen_height * 0.65}
    },
...
awful.spawn.with_shell("setxkbmap -model abnt2 -layout br -variant abnt2 &")
awful.spawn.with_shell("picom &")
awful.spawn.with_shell("xss-lock --transfer-sleep-lock -- i3lock --nofork &")
awful.spawn.with_shell("nm-applet")
awful.spawn.with_shell("$HOME/.config/Scripts/basic/startup.sh")
