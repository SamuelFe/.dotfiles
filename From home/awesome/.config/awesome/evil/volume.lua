...
-- emit_volume_info() using pipewire
local function emit_volume_info()
      awful.spawn.easy_async_with_shell("", function(stdout)
        local volume_int = awful.spawn.with_shell("pamixer --get-volume")
        local muted = awful.spawn.with_shell("pamixer --get-mute")
...
-- emit_volume_info() using pulseaudio
--[[
local function emit_volume_info()
